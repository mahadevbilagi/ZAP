...
public class BodgeITTest {
	...
	private String site = "http://localhost:8085/bodgeit/";
	
	
	public void setUp() throws Exception {
		  Proxy proxy = new Proxy();
		  proxy.setHttpProxy("localhost:4042");
		  proxy.setFtpProxy("localhost:4042");
		  proxy.setSslProxy("localhost:4042");
		 // System.setProperty("webdriver.gecko.driver","D:\\Paywheel_Automated\\geckodriver\\geckodriver.exe");
		  System.setProperty("webdriver.chrome.driver","D:\\OWSAP\\Sunita-ZAP\\ZAP_Sunita\\lib\\chromedriver.exe");
